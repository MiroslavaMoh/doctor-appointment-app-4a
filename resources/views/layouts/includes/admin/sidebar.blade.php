        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-1 font-medium">
                ...
                <li>
                    ...
                    @else
                    <a href="{{ $link['href'] }}" 
                    class="flex items-center p-2 text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <span class="w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 
                                    ...
                                    {{ $link['active'] ? 'dark:group-hover:text-white' : '' }}">
                            <i class="{{ $link['icon'] }}"></i>
                        </span>
